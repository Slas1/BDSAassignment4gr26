...
namespace Assignment4 
{
    public class KanbanContextFactory : IDesignTimeDbContextFactory<KanbanContext>
    {
        ...
        public static void Seed(KanbanContext context)
        {
            ...
            // Creating tasks
            var Task1 = new Task { TaskID = 1, Title= "Make homework", AssignedTo = User1, Description="this is not always a funny task", State = State.Active, Tags = new List<Tag>(){foodTag}};
            var Task2 = new Task { TaskID = 2, Title= "Go for a run", AssignedTo = User3, Description="this is soooo funny", State = State.Active, Tags = new List<Tag>(){FreeTimeTag}};
            var Task3 = new Task { TaskID = 3, Title= "Eat a cupcake", Description="mums", State = State.Resolved, Tags = new List<Tag>(){foodTag,FreeTimeTag}};
            ...
            context.Task.AddRange(
                new List<Task>(){Task1, Task2, Task3}
            );
